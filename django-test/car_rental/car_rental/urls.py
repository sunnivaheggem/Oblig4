...
path("update_car/<int:car_id>", update_car),
path("delete_car/<int:car_id>", delete_car),
path("customers/", get_customer),
path("save_customer/", save_customer),
path("update_customerr/<int:customer_id>", update_customer),
path("delete_customer/<int:customer_id>", delete_customer),
path("employee/", get_employee),
path("save_employee/", save_employee),
path("update_employee/<int:employee_id>", update_employee),
path("delete_employee/<int:employee_id>", delete_employee),
path("order_car/<int:car_id>,<int:customer_id>", order_car),
path("cancle_order_car/<int:car_id>/<int:customer_id>", cancel_order_car),
